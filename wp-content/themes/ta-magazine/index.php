...
<p> Consisten Income From Trading
Unlimited Active Income from Networking bonus
</p>

<a href='http://localhost/sistem.bestopportunity/daftar' class=' btn-danger btn btn-lg'>Daftar Sekarang </a>
	...
	<!-- Content block begin -->
	<section id="content" class="container" style='padding-top:50px;border-left: 1px solid #e0dddd;border-right:1px solid #e0dddd; margin-top:-20px'>
				...
				<div class="row ">
					...
					<div class="col-md-12 kotak">
						...
						<table class='table table-condensed '>
							<tr>
								<td width='20%'>20 mei 2015</td><td>Informasi 1</td>
							</tr>
							<tr>
								<td width='20%'>20 mei 2015</td><td>Informasi 2</td>
							</tr>
							<tr>
								<td width='20%'>20 mei 2015</td><td>Informasi 3</td>
							</tr>
							<tr>
								<td width='20%'>20 mei 2015</td><td>Informasi 4</td>
							</tr>
							<tr>
								<td width='20%'>20 mei 2015</td><td>Informasi 5</td>
							</tr>
						</table>
					</div>
				</div>
